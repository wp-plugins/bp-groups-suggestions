jQuery(document).ready(function() {
    var j = jQuery;
    gototab();
    j(".suggested-group-item-list div.remove-group-suggestion a").live('click', function() {
        var li = j(this).parent().parent().parent().parent();
        j(li).remove();
...
//remove button on groups directory page
    j(".item-list div.remove-group-suggestion a").live('click', function() {
        var button = j(this);
